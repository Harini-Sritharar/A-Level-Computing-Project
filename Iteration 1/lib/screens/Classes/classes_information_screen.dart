            ...
            return AlertDialog(
              ...
              actions: [
                GenericButton("Add", () async {
                  ...
                  await databaseService.getClassQuizzes(appUser.classes[widget.value]);
            ...
            child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    customWidgets.infoCard(Icons.subject_outlined,
                        '${chosenClass.subject}', Colors.blue[700]),
                    customWidgets.infoCard(Icons.class__rounded,
                    ...
                    GenericButton('Quizzes', () async {await databaseService.getClassQuizzes(appUser.classes[widget.value]);
                      Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => ClassQuizScreen(widget.value),
                    ...
                    //                 MaterialPageRoute(
                    //                     builder: (context) =>
                    //                         QuizNavigator(chosenClass.quizzes[i].questions))))
                    //     ],
                    //   ),
                    // ),
                    SizedBox(height: 35),
